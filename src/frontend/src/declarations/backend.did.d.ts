...
export interface _SERVICE {
  ...
  'addProductsBulk' : ActorMethod<[Array<Product>], undefined>,
  ...
  'getPlatformCommissionRate' : ActorMethod<[], bigint>,
  'getProduct' : ActorMethod<[string], [] | [Product]>,
  'getProductsFiltered' : ActorMethod<[string], Array<Product>>,
  'getStoreSettings' : ActorMethod<[string], [] | [StoreSettings]>,
  ...
  'updateStoreSettings' : ActorMethod<
    [string, string, string, [] | [ExternalBlob], SocialLinks],
    undefined
  >,
}
